  ...
  const projects = [
    {
      ...
      stage: '🎉 Volume 1 Paperback Launched — Available Now on Amazon Worldwide',
      eta: 'Out Now (Launched)',
      cover: BOOKS_DATA.lostSoul.coverImage,
      description: 'Volume 1 has officially launched! Physical Paperback editions are live and available exclusively on Amazon.',
    },
    {
      id: 'book_cover_lost_soul_vol2',
      title: BOOKS_DATA.lostSoulVol2?.title || 'The Lost Soul of Throne: Volume 2',
      genre: BOOKS_DATA.lostSoulVol2?.genre || 'Epic High Fantasy Saga',
      progress: BOOKS_DATA.lostSoulVol2?.progressPercent || 35,
      stage: 'Manuscript Drafting & Chapter Outline • Shadow Dragon Lore',
      eta: 'Late 2026 / 2027',
      cover: BOOKS_DATA.lostSoulVol2?.coverImage || BOOKS_DATA.lostSoul.coverImage,
      description: 'The saga expands: Kaelen Aurelius confronts awakening shadow deities and fractured kingdoms.',
    },
    {
