            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-4">
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${friend.avatarColor} p-0.5 shadow-lg`}>
                  ...
                  <div>
                    ...
                    <span className="text-xs text-amber-400/90 font-medium">{friend.role}</span>
                  </div>
                </div>
